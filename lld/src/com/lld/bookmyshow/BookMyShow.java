...
public class BookMyShow {
    ...
    public static void main(String args[]) {
        ...
        Runnable user1 = () -> bookMyShow.createBooking(City.Bangalore, "BAAHUBALI");
        Runnable user2 = () -> bookMyShow.createBooking(City.Bangalore, "BAAHUBALI");
...
//        bookMyShow.createBooking(City.Bangalore, "BAAHUBALI");
    ...
    private void createBooking(City userCity, String movieName) {
        ...
        //implement optimistic locking for this :)
        //5. select the seat
        int seatNumber = 30;
